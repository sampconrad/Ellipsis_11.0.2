...
local function CreateOverlay(owner)
	local f = CreateFrame('Button', nil, owner, BackdropTemplateMixin and "BackdropTemplate")
	f.owner = owner
...
local function CreateHelpDialog()
	...
	local optBtn = CreateFrame('Button', nil, f, 'UIPanelButtonTemplate', BackdropTemplateMixin and "BackdropTemplate")
	...
	local exitBtn = CreateFrame('Button', nil, f, 'UIPanelButtonTemplate', BackdropTemplateMixin and "BackdropTemplate")
