...
function Ellipsis:SpawnExampleAuras()
	...
	if (self.db.profile.cooldowns.enabled) then -- only spawn sample cooldown timers if enabled
		...
		if (timer) then
			...
			CooldownTimer:New(currentTime, 'ITEM', -100001, L.SampleCoolItem, C_Spell.GetSpellTexture(11426), currentTime, 90)
		end
		...
		if (timer) then
			...
			CooldownTimer:New(currentTime, 'PET', -100002, L.SampleCoolPet, C_Spell.GetSpellTexture(186257), currentTime, 12)
		end
		...
		if (timer) then
			...
			CooldownTimer:New(currentTime, 'SPELL', -100003, L.SampleCoolSpell, C_Spell.GetSpellTexture(191427), currentTime, 24)
		end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime, unit, -100001, format(L.SampleAuraDebuff, 1), C_Spell.GetSpellTexture(115767), 400, currentTime + 400, 0))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime + 1, unit, -100002, format(L.SampleAuraDebuff, 2), C_Spell.GetSpellTexture(172), 24, currentTime + 24, 3))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime + 2, unit, -100003, format(L.SampleAuraDebuff, 3), C_Spell.GetSpellTexture(188389), 8, currentTime + 8, 0))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime, unit, -100001, format(L.SampleAuraDebuff, 1), C_Spell.GetSpellTexture(589), 380, currentTime + 380, 0))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime + 1, unit, -100002, format(L.SampleAuraDebuff, 2), C_Spell.GetSpellTexture(30108), 32, currentTime + 32, 10))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime + 2, unit, -100003, format(L.SampleAuraDebuff, 3), C_Spell.GetSpellTexture(51514), 14, currentTime + 14, 0))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime, unit, -100001, format(L.SampleAuraBuff, 1), C_Spell.GetSpellTexture(11426), 420, currentTime + 420, 2))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime + 1, unit, -100002, format(L.SampleAuraBuff, 2), C_Spell.GetSpellTexture(186257), 20, currentTime + 20, 0))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime + 2, unit, -100003, format(L.SampleAuraBuff, 3), C_Spell.GetSpellTexture(191427), 10, currentTime + 10, 0))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime, unit, -100001, L.SampleAuraMinion, C_Spell.GetSpellTexture(55078), 120, currentTime + 120, 0))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime + 1, unit, -100002, L.SampleAuraTotem, C_Spell.GetSpellTexture(605), 40, currentTime + 40, 0))
	end
	...
	if (aura) then
		...
		unit:AddAura(Aura:New(currentTime + 2, unit, -100003, L.SampleAuraGTAoE, C_Spell.GetSpellTexture(8921), 8, currentTime + 8, 0))
	end
	...
	if (self.anchorLookup['player']) then
		...
		if (aura) then
			...
			aura = unit:AddAura(Aura:New(currentTime, unit, -100001, format(L.SampleAuraBuff, 1), C_Spell.GetSpellTexture(209525), 440, currentTime + 440, 0))
		end
		...
		if (aura) then
			...
			aura = unit:AddAura(Aura:New(currentTime + 1, unit, -100002, format(L.SampleAuraBuff, 2), C_Spell.GetSpellTexture(31224), 28, currentTime + 28, 0))
		end
		...
		if (aura) then
			...
			aura = unit:AddAura(Aura:New(currentTime + 2, unit, -100003, format(L.SampleAuraBuff, 3), C_Spell.GetSpellTexture(642), 12, currentTime + 12, 0))
		end
